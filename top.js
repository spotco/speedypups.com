...
function rescale() {
    ...
    $("#main_logo").css({top:-(150+scf*200)+"px", width: Math.min(100,(80 + (1-scf)*60))+"%"})
    $("#vid").css({top:(40*scf)+"px", "padding-left":((1-scf)*30)+"px"})
    $("#vid > iframe").css({height:(225*scf)+"px"})
    $("#submit_form").css({top:(300*scf)+"px"})
    $("#submit_form > input").css({width:(50+25*scf)+"%"})
